...
<head>
    ...
    <title>{{ config('app.name') }}-@yield('title') Панель администратора @if (auth()->user())
            {{ auth()->user()->name }}
        @endif
    </title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-text mx-3">Админ панель @if (auth()->user())
                        {{ auth()->user()->name }}
                    @endif
                </div>
            </a>
            ...
            <li class="nav-item">
                <div class="sidebar-sticky pt-3">                    
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('list.roles')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if (!auth()->user())
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.auth') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
                                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                        ...
                        @else
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <a class="nav-link dropdown-toggle " href="" data-toggle="modal"
                                    ...
                                    <img class="img-profile " src="{{ asset('assets/img/logout.png') }}">
                                </a>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">{{ __('Выберите «Выход» ниже, если вы готовы завершить текущий сеанс.') }}
                </div>
